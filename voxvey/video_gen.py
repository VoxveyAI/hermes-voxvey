...
VIDEO_GENERATIONS_PATH = "/v1/videos/generations"
VIDEOS_PATH = "/v1/videos"
TASKS_PATH = VIDEO_GENERATIONS_PATH
...
class VoxveyVideoGenProvider(VideoGenProvider):
    ...
    def list_models(self) -> list[dict[str, Any]]:
        return [
            {
                "id": "openai/sora-2",
                "display": "OpenAI Sora via Voxvey",
                "speed": "provider-dependent",
                "strengths": "OpenAI native video generation through Voxvey",
                "price": "See Voxvey console",
                "modalities": ["text", "image"],
            },
            {
                "id": "xai/grok-imagine-video",
                "display": "xAI Grok Imagine Video via Voxvey",
                "speed": "provider-dependent",
                "strengths": "xAI native video generation through Voxvey",
                "price": "See Voxvey console",
                "modalities": ["text", "image"],
            },
            {
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if resolution and "size" not in kwargs:
            payload["size"] = {"720p": "1280x720", "1080p": "1920x1080"}.get(resolution)
        optional = {
            "image_url": image_url,
        ...
        try:
            ...
            _status, created = client.request("POST", VIDEO_GENERATIONS_PATH, json_body={k: v for k, v in payload.items() if v is not None})
            ...
            for _ in range(attempts):
                _poll_status, last_data = client.request("GET", f"{VIDEOS_PATH}/{task_id}")
